...
#ifndef GAZEBO_GAZEBO_WORLD_TO_OCTOMAP_PLUGIN_H
#define GAZEBO_GAZEBO_WORLD_TO_OCTOMAP_PLUGIN_H

#include <iostream>
#include <math.h>

#include <maps_manager_pkg/common.h>
#include <gazebo/common/common.hh>
#include <gazebo/gazebo.hh>
#include <gazebo/physics/physics.hh>
#include <octomap/octomap.h>
#include <ros/ros.h>
#include <maps_manager_pkg/Octomap.h>
#include <sdf/sdf.hh>
...
class OctomapFromGazeboWorld : public WorldPlugin {
  ...
  */
  void CreateOctomap(const maps_manager_pkg::Octomap::Request& msg);
 ...
 private:
  ...
  bool ServiceCallback(maps_manager_pkg::Octomap::Request& req,
                       maps_manager_pkg::Octomap::Response& res);
};
